...
/// <summary>Generates MudBlazor pages in the Blazor project. Pages call ApiClient — never DbContext.</summary>
public sealed class BlazorPageGenerator
{
    public IEnumerable<GeneratedFile> Generate(GenerationRequest request)
    {
        ...
        foreach (var table in request.Tables)
        {
            ...
            yield return new GeneratedFile
            {
                ...
                Content      = TemplateLoader.Render("BlazorPage", model)
            };
        }
    }
}
